...
import 'package:mess/widgets/personal_overview.dart';
    ...
    return ListView(
      children: <Widget>[
        Padding(
          ...
          child: SectionTitle(icon: Icons.restaurant, title: 'Today\'s Meals - ' + DateFormat.MMMMEEEEd().format(DateTime.now())),
        ),
        SizedBox(height: 8),
